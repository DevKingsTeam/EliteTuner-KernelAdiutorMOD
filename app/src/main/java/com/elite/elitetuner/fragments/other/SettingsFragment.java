...
import com.elite.elitetuner.activities.BannerResizerActivity;
import com.elite.elitetuner.activities.MainActivity;
import com.elite.elitetuner.activities.NavigationActivity;
import com.elite.elitetuner.services.boot.ApplyOnBootService;
import com.elite.elitetuner.utils.AppSettings;
import com.elite.elitetuner.utils.Themes;
...
import com.elite.elitetuner.views.BorderCircleView;
    ...
    private void resetDataDialog(){
        ...
        alert.setPositiveButton(getString(R.string.ok), (dialog, id) -> {
            ...
            alert2.setNegativeButton(getString(R.string.cancel), (dialogInterface, i) -> {
                ...
                RootUtils.runCommand("pm clear com.elite.elitetuner");
            });
            alert2.setPositiveButton(getString(R.string.ok), (dialog1, id1) -> {
                RootUtils.runCommand("rm -rf /data/.mtweaks");
                RootUtils.runCommand("pm clear com.elite.elitetuner && reboot");
            });
            alert2.show();
        });
        alert.show();
