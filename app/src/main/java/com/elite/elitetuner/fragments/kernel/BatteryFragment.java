...
*/
    ...
    private BroadcastReceiver mBatteryReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            mBatteryCurrent = Utils.strToInt(Utils.readFile("/sys/devices/battery.55/power_supply/battery/current_now"));
            mBatteryCurrentAvg = Utils.strToInt(Utils.readFile("/sys/devices/battery.55/power_supply/battery/current_avg"));
            //sBatteryCharType = Utils.readFile("/sys/devices/battery.55/power_supply/battery/charge_type");
            ...
            mBatteryStatus = Utils.readFile("/sys/devices/battery.55/power_supply/battery/status");
            mBatteryHealth = Utils.readFile("/sys/devices/battery.55/power_supply/battery/health");
