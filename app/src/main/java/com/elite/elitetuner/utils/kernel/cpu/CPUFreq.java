 ...
 *
 */
package com.elite.elitetuner.utils.kernel.cpu;
...
public class CPUFreq {
    ...
    private static final String CPU_MAX_FREQ = "/sys/devices/system/cpu/cpu%d/cpufreq/ren_max_freq";
    private static final String CPU_MAX_FREQ_KT = "/sys/devices/system/cpu/cpu%d/cpufreq/scaling_max_freq_kt";
    private static final String HARD_CPU_MAX_FREQ = "/sys/kernel/cpufreq_hardlimit/ren_max_freq";
